...
# from .prompts import FINANCIAL_QA_PROMPT, COMPARISON_PROMPT, RISK_ANALYSIS_PROMPT
...
#         Uses LCEL (LangChain Expression Language) directly to avoid import issues.
#         """
...
#         # Wrap in a robust invoke interface to match previous expected behavior (dict input/output)
#         class ChainWrapper:
#             def __init__(self, chain, vector_store):
#                 self.chain = chain
#                 self.vector_store = vector_store
            
#             def invoke(self, input_dict):
#                 query = input_dict["input"]
#                 # Get documents separately for source citation (since LCEL hides them in the stream usually)
#                 # But to keep it simple, we just run the chain. 
#                 # Ideally we want sources returned. 
#                 # Let's do a manual retrieve for the UI to show sources.
...
#         return ChainWrapper(rag_chain, vector_store)
...
#         """
#         Analyzes risk factors specifically.
#         """
