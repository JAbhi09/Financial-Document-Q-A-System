...
# from ingestion.sec_loader import process_filing
# from ingestion.vector_store import clear_vector_store, add_documents_to_store, get_collection_stats, delete_documents_by_source


# # Ensure API key is set - not strictly needed for local HF but good practice to keep the check if we switch back
...
#     # Chroma automatically persists in newer versions, but explicit persist can be safer
#     # vectorstore.persist() 
